...
public class Config {
	...
	public static String SERVER_NAME = "TrisidiaX";///Replaceing this will Change name of the server
	public static final String DONATION_AMOUNT = "$0.00";///Add the vote.php here only
	public static final String WELCOME_MESSAGE = "Welcome to TrisidiaX";///replace this log in message
	public static final String WEBCLIENT = "www.trisidiax.niceboard.com/h1-trisidiax-webclient";///replace this log in message
	public static final String FORUMS = "www.trisidiax.NiceBoard.com";///Replace this link to replace all the forums
	public static final String BUY_SPINS = "";///This is the link to buy spins
	public static final String PAYPAL_EMAIL = "TrisidiaX317@gmail.com";///Enter the name of the site when you spam players
	...
	public static final String OWNER = "Trisidia";///
	public static final String CO_OWNER = "Kings";///
