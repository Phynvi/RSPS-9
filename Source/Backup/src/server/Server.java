...
try {
	...
	ex.printStackTrace();
		...
		System.out.println("Launching "+Config.SERVER_NAME+" Coded And created By Trisidia");
		 ...
		 */
		System.out.println("TrisidiaX Ip: TrisidiaX.Niceboard.com With the port: " + serverlistenerPort);
		/**
		 * Main Server Tick
		 */
		try {
	...
	private static void debug() {
		if (debugTimer.elapsed() > 360*1000 || playerExecuted) {
			...
			System.out.println("There are " + PlayerHandler.playerCount+ " Players On Trisidiax");
			System.out.println("TrisidiaX is Running the Egine with: " + debugPercentFormat.format(engineLoad) + "Strain");
			totalCycleTime = 0;
			cycles = 0;
			System.gc();
