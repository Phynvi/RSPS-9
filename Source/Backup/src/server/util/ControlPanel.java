...
public class ControlPanel extends JFrame {
	...
	public void initComponents() {
		...
		ADMINS_DUEL_ITEMS = new JCheckBox();
		...
		FORCE_COMMANDS.setModel(new AbstractListModel() {
			String[] strings = {"Demote", "Give Donator", "Give Super", "Give Extreme", "Give Graphics", "Give Mod", "Give Admin", "Give Co-Owner", "Give Donator Points", "Give Spins", "Give Level Points", "Give Vote Points", "Give Zombie Points", "Give Dung Points", "Give PK Points", "Give Slayer Points", "Give NpcKills", "Set Killstreak", "Force Logout", "Force Animation", "Display GFX", "Lock EXP", "Force Bank", "Force Shop", "Force Death", "Force Command", "Force Chat", "Give Master", "Add SkillXP", "Remove SkillXP", "Reset Skill", "Reset All Skills" };
		...
		KICK_ALL.setText("Log Out");
		KICK_ALL.setToolTipText("Make every player in TrisidiaX LogOut");
		...
		FORCE_NPCS_CHAT_TEXT.setText("All type ::Vote4cash after you vote type ::reward");
		...
		ADMINS_CAN_TRADE.setText("Admins can Trade Items");
		ADMINS_CAN_TRADE.setToolTipText("Determins wether or not an admin can trade other players.");
		
		ADMINS_CAN_DROP.setText("Admins can Drop Items");
		...
		ADMINS_DUEL_ITEMS.setText("Admins can Stake Items");
		ADMINS_DUEL_ITEMS.setSelected(Config.ADMIN_DUEL_ITEMS);
		ADMINS_DUEL_ITEMS.setToolTipText("Determins wether or not an admin can Stake items with other players..");
				...
				.addGroup(SETTINGS_PANELLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
					...
					.addGroup(SETTINGS_PANELLayout.createSequentialGroup()
						.addGroup(SETTINGS_PANELLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
							...
							.addComponent(ADMINS_DUEL_ITEMS)
		...
		RESET_NPCS_LABEL.setText("Restart Server:");

		RESET_NPCS_BUTTON.setText("Restart");
		RESET_NPCS_BUTTON.setToolTipText("This will restart the whole server.");
		RESET_NPCS_BUTTON.setToolTipText("This will restart the whole server.");
		...
		Image icon = getImage("TrisidiaXControlPanel.png");
		if(icon != null)
	...
	private Image getImage(String name) {
		String url = "https://dl.dropbox.com/u/91577463/Pictures/" + name;
		try {
	...
	public JCheckBox ADMINS_DUEL_ITEMS;
