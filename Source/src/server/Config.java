...
public class Config {
	...
	public static String SERVER_NAME = "ServerNameHere";///Replaceing this will Change name of the server
	public static final String DONATION_AMOUNT = "$0.00";///Add the vote.php here only
	public static final String WELCOME_MESSAGE = "Welcome to ServerNameHere";///replace this log in message
	public static final String WEBCLIENT = "";///replace this log in message
	public static final String FORUMS = "";///Replace this link to replace all the forums
	public static final String BUY_SPINS = "";///This is the link to buy spins
	public static final String PAYPAL_EMAIL = "";///Enter the name of the site when you spam players
	public static final String VOTE4CASH = "www.trisidiax.netii.net/vote.php";///Add the vote.php here only
	public static final String SITE_SPAM = "www.Google.com";///Enter the name of the site when you spam players " + Config.SITE_SPAM + "
	public static final String SITE_SPAM2 = "www.OMFGDOGS.com";///Enter the name of the site when you spam players
	public static final int CLIENT_VERSION = 1;
	
	public static final String OWNER = "trb25";///
	public static final String CO_OWNER = "reldo";///
	public static final String HEAD_ADMIN = "Lexi";///
	public static final String ADMIN = "Non";///
	public static final String HEAD_MOD = "Jordan";///
	...
	public static final String GRAPHICS_TEAM = "open";///
	public static final String STAFF_OPENINGS = "Open";///
	
	public static final String TRADE_DISABLED_ONE = "Jordan";
	public static final String TRADE_DISABLED_TWO = "Kings";
	...
	public static final String DROP_DISABLED_ONE = "Jordan";
	public static final String DROP_DISABLED_TWO = "Kings";
	...
	public static final String DUELING_DISABLED_ONE = "Jordan";
	public static final String DUELING_DISABLED_TWO = "Kings";
	...
	public static final String NEWS_ONE = "<col=16777215><shad=14024897>["+ Config.SERVER_NAME +" News]:</col></shad><col=16777215><shad=62207> Donations Include Xat and Paypal Donations Only!";
	public static final String NEWS_TWO = "<col=16777215><shad=14024897>["+ Config.SERVER_NAME +" News]:</col></shad><col=16777215><shad=62207> Donation Amount:" + Config.DONATION_AMOUNT + "! PayPal donors Donate!:D";
	public static final String NEWS_THREE = "<col=16777215><shad=14024897>["+ Config.SERVER_NAME +" News]:</col></shad><col=16777215><shad=62207>  All PayPal donations send to " + Config.PAYPAL_EMAIL + " Only!";
