...
public class ActionHandler {
	private Client c;
			int[] donatorRitem = { 12435, 4151, 15441, 15442, 15443, 15444, 15241, 4753, 4755, 4757, 4759, 14595, 14603, 14602, 14605, 11235, 19308, 19311, 19314, 19317, 19320 };
	...
	int[] PvpPrices = { 10000000, 15000000, 500000, 35000, 800000,150000, 280000, 840000, 150000, 125000, 80000, 5000000, 240000, 108700, 200000, 284000 };
...
case 2015:
		...
		c.sendMessage("You have received 30 Zombie Points for this.");
		c.getPA().resetZombies();
		c.pfPoints += 30;
			}
		case 10779:
		
			c.getPA().movePlayer(3297, 9824, 0);
			c.sendMessage("You teleport to the Demon Caves");
			break;
		case 10870:
			c.getPA().movePlayer(2207, 4720, 4);
		c.sendMessage("You teleport to the death dungeon");
		break;
		case 1765:
		...
		break;
			...
			break;
			case 10597:
			c.getPA().movePlayer(3055, 9561, 0);
			break;
			case 11005:
			if (c.getItems().playerHasItem(18314,1) && c.getItems().freeSlots() >= 1) {
			if (c.getX() >= c.objectX)
			c.getPA().walkTo(-1,0);
		} else {
			c.sendMessage("Get the Key from the wizard first");
			break;
			}
			case 2295:
					c.sendMessage("You sucessfuly make it across the log to the other side.");
					c.getAgil().AgilityLog(c, "Log", 1, 0, -7, 2474, 3436, 1000);
					c.ag1 = 1;
					break;
			case 2285:
					c.startAnimation(828);
					c.sendMessage("You sucessfuly climb the net.");
					c.getAgil().AgilityNet(c, "Net", 1, 2471, 3426, 1, 2471, 3424, 828, 1300);
					c.getAgil().AgilityNet(c, "Net", 1, 2472, 3426, 1, 2472, 3424, 828, 1300);
					c.getAgil().AgilityNet(c, "Net", 1, 2473, 3426, 1, 2473, 3424, 828, 1300);
					c.getAgil().AgilityNet(c, "Net", 1, 2474, 3426, 1, 2474, 3424, 828, 1300);
					c.getAgil().AgilityNet(c, "Net", 1, 2475, 3426, 1, 2475, 3424, 828, 1300);
					c.getAgil().AgilityNet(c, "Net", 1, 2476, 3426, 1, 2476, 3424, 828, 1300);
					c.ag2 = 1;
					break;

				case 2313:
					c.startAnimation(828);
					c.sendMessage("You sucessfuly climb up the tree.");
					c.getAgil().AgilityBranch(c, "Branch", 1, 2473, 3420, 2, 2473, 3423, 828, 1200);
					c.getAgil().AgilityBranch(c, "Branch", 1, 2473, 3420, 2, 2474, 3422, 828, 1200);
					c.getAgil().AgilityBranch(c, "Branch", 1, 2473, 3420, 2, 2472, 3422, 828, 1200);
					c.ag3 = 1;
					break;
				case 2312:
					c.getAgil().AgilityLog(c, "Log", 1, +6, 0, 2477, 3420, 1300);
					c.ag4 = 1;
					break;
				case 2314:
					c.startAnimation(828);
					c.sendMessage("You sucessfuly climb down the tree.");
					c.getAgil().AgilityBranch(c, "Branch", 1, 2486, 3420, 0, 2485, 3419, 828, 1400);
					c.getAgil().AgilityBranch(c, "Branch", 1, 2486, 3420, 0, 2485, 3420, 828, 1400);
					c.getAgil().AgilityBranch(c, "Branch", 1, 2486, 3420, 0, 2486, 3420, 828, 1400);
					c.ag5 = 1;
					break;
				case 2286:
					c.startAnimation(828);
					c.sendMessage("You sucessfuly climb the net.");
					c.getAgil().AgilityNet(c, "Net", 1, 2483, 3425, 0, 2483, 3427, 828, 500);
					c.getAgil().AgilityNet(c, "Net", 1, 2484, 3425, 0, 2484, 3427, 828, 500);
					c.getAgil().AgilityNet(c, "Net", 1, 2485, 3425, 0, 2485, 3427, 828, 500);
					c.getAgil().AgilityNet(c, "Net", 1, 2486, 3425, 0, 2486, 3427, 828, 500);
					c.getAgil().AgilityNet(c, "Net", 1, 2487, 3425, 0, 2487, 3427, 828, 500);
					c.getAgil().AgilityNet(c, "Net", 1, 2488, 3425, 0, 2488, 3427, 828, 500);
					c.ag6 = 1;
				...
				case 154:
					...
					c.sendMessage("You sucessfuly climb through the pipe");
					c.getAgil().AgilityPipe(c, "Pipe", 1, 2484, 3430, 0, +7, 2996, 10, 600);
					break;
				case 4058:
					c.fmwalkto(0, 1);
					c.startAnimation(749);
					c.getAgil().AgilityPipe(c, "Pipe", 1, 2487, 3430, 0, +7, 2996, 10, 600);
					break;
			case 2284:
			  c.getPA().addSkillXP(1500, 16);
			  ///c.getPA().movePlayer(2271, 4680, 0);
			  c.startAnimation(434);
			  break;
			 case 26288:
			case 26287:
			case 26286:
		...
		case 7139:
		c.getPA().startTeleport(2845, 4843, 0, "modern");
		c.sendMessage("<img=1> Air altar.");
		break;		
		case 7140:
		c.getPA().startTeleport(2788, 4835, 0, "modern");
		c.sendMessage("<img=1> Mind Altar.");
		break;
		case 7131:
		c.getPA().startTeleport(2528, 4833, 0, "modern");
		c.sendMessage("<img=1> Body Altar.");
		break;
		case 7129:
		c.getPA().startTeleport(2584, 4836, 0, "modern");
		c.sendMessage("<img=1> Fire Altar.");
		break;
		case 7135:
		c.getPA().startTeleport(2564, 4820, 0, "modern");
		c.sendMessage("<img=1> Law Altar.");
		break;
		case 1991:
		c.getPA().startTeleport(2204, 4834, 0, "modern");
		c.sendMessage("<img=1> Death Altar.");
		break;
		
		case 1757:
		c.getPA().startTeleport(3179, 4820, 0, "modern");
		c.sendMessage("<img=1> You teleport safely home.");
		break;		
				
		case 2511:
		c.getPA().startTeleport(3063, 4831, 0, "modern");
		c.sendMessage("<img=1> You teleport to the other side, click the boil to get to the other side.");
		break;		
		case 7151:
		c.getPA().startTeleport(3054, 4831, 0, "modern");
		c.sendMessage("<img=1> You teleport to the other side, click the ladder to get to other side.");
		break;		
		...
		case 8972:
		if((c.playerLevel[21] < 90) && (c.playerLevel[18] < 90)) {
		c.sendMessage("You need 90 Agility And 90 Slayer to enter the Strykeworm's Cave");
		} else {
		if((c.playerLevel[21] > 89) && (c.playerLevel[18] < 90)) {
		c.sendMessage("You need 90 Agility to enter the Strykeworm's Cave");
		} else {
		if((c.playerLevel[21] < 90) && (c.playerLevel[18] > 89)) {
		c.sendMessage("You need 90 Slayer to enter the Strykeworm's Cave");
		} else {
...
case 2471:
		...
		break;
				case 4151:
		c.getPA().movePlayer(2668, 10097, 2);
		c.sendMessage("You teleport to the Skeleton Floor.");
		break;
		
		case 8987:
		c.getPA().movePlayer(2672, 10064, 0);
		break;
		...
		break;
		case 8744:
		c.getPA().movePlayer(2352, 3181, 1);
		break;
		case 8746:
		c.getPA().movePlayer(2352, 3181, 0);
		break;
		case 13623:
		c.getPA().movePlayer(2837, 3806, 0);
		...
		break;
		case 5259:
		      c.getPA().movePlayer(3660, 3508, 0);
		break;
		case 26303:
		...
		case 10251:
			c.SaveGame();
			c.getItems().addItem(19791, 1);
			c.sendMessage("<img=2><shad=99231>If you don't teleport, try moving around the portal");
			c.getPA().startTeleport(3659, 3516, 0, "modern");
		break;
		case 26293:
		...
		break;
			...
			if (c.playerMagicBook == 0) {
				if(c.playerEquipment[c.playerWeapon] == 4675 || c.playerEquipment[c.playerWeapon] == 15486 || c.playerEquipment[c.playerWeapon] == 15040 || c.playerEquipment[c.playerWeapon] == 17293) {
...
break;
		case 172:
if (c.getItems().playerHasItem(4278,20000) && c.getItems().freeSlots() >= 1) {
c.getItems().deleteItem(4278, 20000);
c.getItems().addItem(c.getPA().randomEcko(), 1);
c.SaveGame();
c.getDH().sendDialogues(38, 945);
} else {
c.getDH().sendDialogues(500, 945); }
break;
		case 1182:
c.getDH().sendDialogues(3000, 4289);
break;
...
c.storing = false;
		...
		c.sendMessage("You Can't Leave out of FunPK you pussy...");
		break;
		case 14235:
		case 14233:
			if (c.objectX == 2670)
	...
	public void secondClickObject(int objectType, int obX, int obY) {
		...
		switch(objectType) {
			...
			case 4874:
				c.getThieving().stealFromStall(19296, 10, 1);
	...
	c.fishitem = -1;
		...
		switch(npcType) {
		/**case 242:
		if (c.getItems().playerHasItem(6722,25)) {
		//c.getDH().sendDialogues(998, npcType);
		
		c.getItems().addItem(6570, 1);
		c.getItems().deleteItem(6722, 25);
		c.getItems().deleteItem(6722, 25);
		c.getItems().deleteItem(6722, 25);
		c.getItems().deleteItem(6722, 25);
		c.getItems().deleteItem(6722, 25);
		...
		break;*/
		case 241:
		c.getDH().sendDialogues(995, npcType);
		break;   
		 case 506://zombie minigame shop
				c.getShops().openShop(95);
			break;
		case 9709:
		c.getPA().startTeleport(3363, 3304, 0, "other");
		c.sendMessage("You teleport to the Extra Boss/Monster Area Teleports");
		break;
		case 8206:
        if(c.playerRights <= 1 || c.playerRights == 4 /**|| c.playerRights == 5*/) {
		...
		c.sendMessage("You must have 99 Hunter to access this shop");
		}
		break;
		...
		c.sendMessage("You must have 1,000 NPC Kills to access to God Shops");
		...
		c.sendMessage("SUGGESTION SHOP");
		break;
		case 756:
		c.getShops().openShop(54);
		c.sendMessage("Remember to vote every 4 hours, or 2 if you are a RSWebclients donator!");
		c.sendMessage("You currently have "+c.votePoints+" ");
		break;
		case 8723:
		c.getPA().startTeleport(2198, 3266, 0, "other");
		c.sendMessage("You teleport to the Elf Camp, You can get Crystal bows, shields, and Mjolnirs here.");
		break;
		case 243:
		if (c.getItems().playerHasItem(4211,100) && c.getItems().freeSlots() >= 1) {
		c.getItems().addItem(4212, 1);
		c.getItems().deleteItem(4211, 100);
		}else{
		c.sendMessage("You must have 100 Elf Crystals to buy a bow");
		}
		break;
		case 245:
		if (c.getItems().playerHasItem(995,1000000) && c.getItems().freeSlots() >= 1) {
		c.getDH().sendDialogues(995, npcType);
		}else{
		c.sendMessage("You must have 1 Million Gold to talk to The TXP Exchanger");
		}
		break;
		case 244:
		if (c.getItems().playerHasItem(4211,100) && c.getItems().freeSlots() >= 1) {
		c.getItems().addItem(4224, 1);
		c.getItems().deleteItem(4211, 100);
		}else{
		c.sendMessage("You must have 100 Elf Crystals to buy a Shield");
		}
		break;
		case 2639:
		c.getPA().startTeleport(2908, 9694, 12, "other");
		c.sendMessage("You teleport to the Elite Black Knights, You can get Elite Black Armor here");
		break;
		case 2290:
		c.getPA().startTeleport(2964, 3359, 0, "other");
		c.sendMessage("You teleport to the White Knights, You can get White Armor here");
		break;
		case 755:
		c.getShops().openShop(53);
		c.sendMessage("Good old days lol.");
		break;
		case 200:
		c.getShops().openShop(52);
		c.sendMessage("Too Hot for Armor Eh? :D");
		break;
		case 33:
		c.getShops().openShop(51);
		c.sendMessage("Welcome back to F2P Newbeh.");
		break;		
		case 8032:
		c.getItems().addItem(18314, 1);
		break;
		...
		case 2244:
			c.getPA().showInterface(26099);
				...
				c.getPA().sendFrame126("@or1@TXP points: @gre@"+c.pkPoints+"  ", 26113);
			...
			break;
			case 9208:
			c.getPA().startTeleport(3202, 3854, 0, "other");
			break;
			case 2127:
...
break;
		...
		break;
			...
			break;
			case 548:
			c.sendMessage("Have Fun Chilling :)");
...
//c.getPA().sendFrame126(""+c.dungPoints+"", 18071);
			...
			case 9711:
				...
				c.sendMessage("You currently have <shad=990>" + c.dungPoints + "</col> Dungeoneering Points.");
			break;
			case 9713:
...
c.getPA().sendFrame126(""+c.dungPoints+"", 18071);
		...
		c.getItems().addItem(15272, 20);
		c.getItems().addItem(16845, 1);
		c.getItems().addItem(16911, 1);
		c.getItems().addItem(17151, 1);
		c.getItems().addItem(16977, 1);
			c.sendMessage("You receive some noob pking gear.");
			break;
			case 8591:
			...
			break;
			case 6747:///Vote Point Shop
				c.getShops().openShop(20);
				c.sendMessage("You currently have <col=255>" + c.votePoints + "</col> Vote Points.");
			break;
			case 6748:///Tokkul Point Shop
		...
		c.sendMessage("<shad=16745472>[Server]</col><shad=65288>You must have 1,000 NPC Kills to access the Members Shop.");
		}
		break;
			case 1008:
			...
			case 2830:
				...
				c.sendMessage("You currently have <col=255>" + c.pkPoints + "</col> "+ Config.SERVER_NAME +" Points (TXP).");
			break;
			case 5030:
			...
			case 659:
				c.SaveGame();
				c.sendMessage("You teleport to the Money Making Zone");
				c.getPA().startTeleport2(2723, 2988, 0);
			break;
			case 1294:
			...
			break;
			case 520:
				c.sendMessage("Tickets are in the shop to help store your money away.");
			...
			case 542:
				 if (c.isDonator >= 1) {
       				...
       				c.sendMessage("You must be a donator to open this shop!.");
   				}
				break;
			case 541:
		...
		// end of hunter :)
			...
			break;
			case 3789:
				c.sendMessage("You currently have " + c.pkPoints + " "+ Config.SERVER_NAME +" Points (TXP).");
			break;
			case 3788:
				c.getShops().openVoid();
			break;
	...
	c.fishitem = -1;
		...
		switch(npcType) {
			...
			if(c.getItems().playerHasItem(995, 200)) {
				c.getDH().sendDialogues(1002, 2296);
				c.getItems().deleteItem2(995, 200);
			} else {
				c.getDH().sendDialogues(1003, 2296);
			}
			break;
		...
		case 2294:
			if(c.getItems().playerHasItem(995, 200)) {
				c.getDH().sendDialogues(1009, 2294);
				c.getItems().deleteItem2(995, 200);
			} else {
				c.getDH().sendDialogues(1011, 2294);
			}
			break;
		case 312:
                    c.fishing = true;
