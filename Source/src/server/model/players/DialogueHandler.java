...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
        ...
        break;
		case 36899:
                sendOption4("Exchange my 2000M for a Ticket.", "What is this?", "", "GoodBye.");
                c.dialogueAction = 36899;
                break;
		
			case 185:
                        sendNpcChat4("Hello, im Lottie and i'm in charge of TrisidiaX's Lottery.", "Entering costs 10 million gp but you could win up to", "500 million gp! you can enter up to 2 times per draw.", "Would you like to enter the lottery?", c.talkingNpc, "Lottie");
                        c.nextChat = 186;
                break;
                case 186:
                ...
                break;
		case 995:
		sendNpcChat4("Hello there "+c.playerName+"!"," Would you like to start the zombie minigame?","Kill the zombies and complete the wave","To claim a trophy", c.talkingNpc, "Zombie Expert");
			c.nextChat = 996;
			break;
		/**case 998:
 sendStatement("You exchange 25 zombie heads for a fire cape!");
			c.nextChat = 0;
break;*/
/**case 999:
 sendStatement("You must have 25 zombie heads to purchase a fire cape!");
			c.nextChat = 0;
		break;*/
		case 996:
		sendNpcChat4("When in Game The wall is the way out,"," To get prizes talk to Rashiliyia","To exchange your points for items.","Would you like the start the game?", c.talkingNpc, "Zombie Expert");
			c.nextChat = 997;
			break;
			case 997:
		sendOption3("Yes, I'm Ready!", "No i need to gear up first."," No i need to gear up first. ");
		...
		case 106:
				...
				break;
			case 28:
			sendNpcChat4("@red@Thanks for Downloading and using TrisidiaXV3 Source", " @red@If you have any questions ask Trisidia on Skype 'Trisidia X' ", "Please Give //TeamTrisidiaX Some credit", "", c.talkingNpc, "Message From //TeamTrisidiaX");
			c.nextChat = 0;
			///c.nextChat = 29;
			break;
			case 29:
			sendOption2("Open Vote4Cash for me.", "Ill Vote Later.");
			c.dialogueAction = 29;
			c.nextChat = 0;
			break;
			...
			case 107:
				...
				break;
                case 70:
				sendNpcChat4("Hello there "+c.playerName+"!", " Welcome to TrisidiaX", "I'm here to tell you the benefits", "Of this server!", c.talkingNpc, "Duke");
				c.nextChat = 71;
				break;
				case 71:
				sendNpcChat4("First of All, the Main owner is Trisidia", "He works very hard making the server addictive!", "This is mainly a PvM Server", "There is also Elite Slayer!", c.talkingNpc, "Duke");
				c.nextChat = 72;
				break;
				case 72:
				sendNpcChat4("There is also a TOKKUL currency", "All the NPCs at the Tzhaar Caves drop", " TOKKUL, there is also a TOKKUL", "Shop, so start raising up", c.talkingNpc, "Duke");
				c.nextChat = 73;
				break;
				case 73:
				sendNpcChat4("Almost all NPCs drop Ecto-Tokens.", "Once you get 100k ecto-tokens", " Click the chest right by the crystal chest", "You will receive a rare item!", c.talkingNpc, "Duke");
				c.nextChat = 74;
				break;
				case 74:
				sendNpcChat4("I hope you enjoy your stay!", "There is tons more to do on the server!", " To start making money, train hunter!", "You can loot dragon imps.", c.talkingNpc, "Duke");
				c.nextChat = 0;
				break;
		...
		case 80:
		 ...
		 case 500:
                        sendStatement("You need 20,000 Ecto-Tokens to access this Chest!!");
                        c.nextChat = 0;
                break;		

		case 55:
		sendNpcChat4("Hello i am in charage of TrisidiaX SOF", "You must have spins to play my game.",
			"If you do not have spins talk to Trisidia", "", c.talkingNpc, "Drawf snowman");
			c.nextChat = 56;
			break;
		case 56:
			...
			case 57:
                ...
                break;
				case 60:
						sendStatement("You have earned 4 Voteing points for voting, Thanks for Voting! -Trisidia");
						c.nextChat = 0;
				break;
				case 30:
	...
	case 51:
		...
		case 2:
			...
			break;
		case 3:
			sendNpcChat4("I am Duradel", "The King and master of the slayer skill.", "I can assign you a slayer task suitable to your combat level.", 
		...
		break;
		case 13:
			sendNpcChat4("I am Duradel", "The King and master of the slayer skill.", "I see I have already assigned you a task to complete.", 
